...
public class LineChartManager {
    ...
    private String limit_value = "荧光阈值";
...
//        rightAxis.setAxisMaximum(10000);
        rightAxis.setEnabled(false);//关闭右边的Y轴，因为默认有两条，左边一条，右边一条，MPAndroidChart中有setEnabled方法的元素基本上都是使能的作用
    ...
    private void initLineChart() {
        ...
        LimitLine limitLine = new LimitLine(CardApplication.limitLineValue);
        //设置限制线的宽
        ...
        limitLine.setLabel("荧光阈值");
        //设置限制线为虚线
        //limitLine.enableDashedLine(10f, 10f, 0f);
        //左边Y轴添加限制线
        leftAxis.addLimitLine(limitLine);*/
        setHightLimitLine(CardApplication.limitLineValue, limit_value, Color.RED);
     ...
     * @param color
     */
    public void showSingerLineChart(List<Integer> xAxisValues, List<Integer> yAxisValues, String label, int color) {
        initLineChart();
     ...
     * @param colours
     */
    public void showLineChart(List<Integer> xAxisValues, List<List<Integer>> yAxisValues, List<String> labels, List<Integer> colours) {
        initLineChart();
        ArrayList<ILineDataSet> dataSets = new ArrayList<>();
